...
model_type = "mbert"  # mbert, xlm-r
tokenizer_ckpt = "bert-base-multilingual-cased"  # bert-base-multilingual-cased, xlm-roberta-base
max_length = 510
...
def infer(tgt_lang: str, model_type: str, tokenizer_ckpt: str, max_length: int):
    ...
    ner_dataloader = TagAncDataLoader(
        lang=tgt_lang, tok_pretrained_ck=f"tokenizer_ckpt/sptok/{tgt_lang}", max_length=max_length
    )

...
from transformers import BertAdapterModel, BertTokenizerFast
from UniBridge import SPTokenizerFast, UniBridgeEmbedding
...
def gen_weight(tgt_lang: str, from_flores: bool = True):
    ...
    src_langs = ["en", "ru", "zh", "ar", "ja"]  # for NLI, remove "ja"
    src_tokenizer = BertTokenizerFast.from_pretrained("bert-base-multilingual-cased")
    tgt_langs = [tgt_lang]
